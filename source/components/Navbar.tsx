        ...
        <header className="absolute inset-x-0 top-0 z-50">
            <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1">
                    <a href="/" className="-m-1.5 p-1.5 scale-150">
                        <svg className="h-8 w-auto opacity-80" fill="#000" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex justify-end">
                    <a href="https://github.com/ThijmenGThN/directus-themebuilder" className="text-sm font-normal leading-6 text-gray-700">
