...
export default function Community() {
    ...
    const pullPeople = async (type: 'contributors' | 'stargazers') => (await axios.get('https://api.github.com/repos/ThijmenGThN/directus-themebuilder/' + type)).data
                            ...
                            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                                <div className="mx-auto max-w-2xl lg:mx-0">
                                    ...
                                    <p className="mt-6 text-lg leading-8 text-gray-600">
                                        The wizards who built and maintain this project - Join us on an adventure!
                                    </p>
                                </div>
